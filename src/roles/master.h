...
enum User : uint8_t { Master, Slave };
...
enum Cell : uint8_t { CELL_EMPTY, CELL_SHIP, CELL_HIT, CELL_MISS, CELL_SUNK, CELL_ALREADY_TARGETED };
...
struct MasterGameState {
    ...
    uint8_t master_cursor_x = 0;
    uint8_t master_cursor_y = 0;
    uint8_t slave_cursor_x = 0;
    uint8_t slave_cursor_y = 0;
